        ...
        <section className="flex flex-col-reverse md:flex-row p-4 pt-12 md:px-32 md:pb-64 md:min-h-[70vh]">
          <section className="w-full md:w-7/12 mt-8 md:mt-0 pr-0 md:pr-12 flex flex-col">
            ...
            <p className="font-light mt-8 dark:text-white">
              Officia sit in duis aliqua anim aliquip nulla laboris. Magna id
              excepteur veniam fugiat velit do adipisicing fugiat consectetur
              eiusmod dolore eu aliquip. Laboris ut duis dolor adipisicing
              proident mollit elit in reprehenderit labore dolor laboris. Enim
              dolore esse incididunt qui. Ea aute veniam culpa ex sint nisi
              commodo dolor. Nulla qui incididunt qui dolor amet minim officia
              non
            </p>
      ...
      <section className="flex flex-col bg-[#f7f8fa] dark:bg-gray-800 py-20 md:py-32 justify-center">
        <section className="flex  dark:bg-gray-800 flex-col px-2 md:px-8">
          <section className="flex justify-center">
            <h1 className="font-bold dark:text-white hidden md:block mt-8 text-2xl">Investments for you</h1>
